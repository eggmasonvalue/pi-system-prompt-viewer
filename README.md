...
Display what sits above the first user message in a scrollable overlay: the assembled [Pi](https://pi.dev) system prompt, then the active tool objects as Pi exposes them.
